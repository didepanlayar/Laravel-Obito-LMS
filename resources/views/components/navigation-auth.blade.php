    ...
    <div class="flex w-[1280px] px-[75px] py-5 items-center justify-between mx-auto">
        ...
        <div class="flex items-center gap-5 justify-end">
            ...
            <a href="catalog-v2.html" class="flex shrink-0">
                <img src="{{ asset('obito/assets/images/icons/category.svg') }}" class="flex shrink-0" alt="icon">
            </a>
            <a href="javascript:void(0)" class="flex shrink-0">
                <img src="{{ asset('obito/assets/images/icons/notification.svg') }}" class="flex shrink-0" alt="icon">
            </a>
            ...
            <div id="profile-dropdown" class="relative flex items-center gap-[14px]">
                ...
                <button id="dropdown-opener" class="flex shrink-0 w-6 h-6">
                    <img src="{{ asset('obito/assets/images/icons/arrow-circle-down.svg') }}" class="w-6 h-6" alt="icon">
                </button>
