...
@section('title', 'My Subscriptions - Obito Online Learning Platform')
                    ...
                    <div class="subscription-card bg-white border border-obito-grey flex items-center justify-between rounded-[20px] py-5 px-4 gap-8">
                        <div class="flex items-center flex-1 gap-[14px]">
                            <div class="flex shrink-0 size-[50px]">
                                <img src="{{ asset('obito/assets/images/icons/cup-green-fill.svg') }}" class="flex shrink-0 size-[50px]" alt="icon">
                            </div>
                            <div>
                        ...
                        <div class="flex flex-col w-[100px] shrink-0 gap-1">
                            <div class="flex items-center gap-1">
                                <img src="{{ asset('obito/assets/images/icons/note.svg') }}" class="flex w-5 shrink-0" alt="icon">
                        ...
                        <a href="{{ route('dashboard.subscription.detail', $transaction) }}" class="rounded-full border border-obito-grey py-[10px] px-5 gap-[10px] bg-white hover:border-obito-green transition-all duration-300">
