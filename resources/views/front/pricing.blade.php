            ...
            <div class="flex items-center gap-5">
                <div class="price-card-reguler flex flex-col h-fit w-full max-w-[314px] shrink-0 rounded-[20px] p-5 border border-obito-grey gap-5 bg-white">
                    <div class="flex items-center gap-[14px]">
                        <img src="{{ asset('obito/assets/images/icons/award-black-fill.svg') }}" class="flex w-[60px] shrink-0" alt="icon">
                    ...
                    <div class="flex flex-col gap-4">
                        <p class="flex items-center gap-2">
                            <img src="{{ asset('obito/assets/images/icons/tick-circle-green-fill.svg') }}" class="flex shrink-0" alt="icon">
                ...
                @foreach ($pricingPackages as $package)
                    <div class="price-card-popular flex flex-col h-fit w-full max-w-[314px] shrink-0 rounded-[20px] border-2 border-obito-green gap-5 bg-white overflow-hidden">
                        ...
                        <div class="flex flex-col gap-5 p-5 pt-0">
                            <div class="flex items-center gap-[14px]">
                                <img src="{{ asset('obito/assets/images/icons/cup-green-fill.svg') }}" class="flex w-[60px] shrink-0" alt="icon">
                ...
                <div class="price-card-reguler flex flex-col h-fit w-full max-w-[314px] shrink-0 rounded-[20px] p-5 border border-obito-grey gap-5 bg-white">
                    <div class="flex items-center gap-[14px]">
                        <img src="{{ asset('obito/assets/images/icons/buildings-green-fill.svg') }}" class="flex w-[60px] shrink-0" alt="icon">
            ...
            <div id="testimonial-slide" class="w-full flex flex-nowrap overflow-x-hidden">
                <div class="slide-container flex gap-5 pl-5 flex-nowrap animate-[slide_50s_linear_infinite]">
                    <div class="testimonial-card flex flex-col w-[359px] shrink-0 rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                        <div class="flex">
                            <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="flex shrink-0 w-5" alt="star">
                            <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="flex shrink-0 w-5" alt="star">
                            <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="flex shrink-0 w-5" alt="star">
                            <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="flex shrink-0 w-5" alt="star">
                            <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="flex shrink-0 w-5" alt="star">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden bg-obito-grey">
                                <img src="{{ asset('obito/assets/images/photos/anggaphoto.png') }}" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                    ...
                    <div class="testimonial-card flex flex-col w-[359px] shrink-0 rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden bg-obito-grey">
                                <img src="{{ asset('obito/assets/images/photos/sami.png') }}" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                                <p class="font-semibold">Angga Risky</p>
                                <p class="text-sm text-obito-text-secondary">Full Stack Developer</p>
                    ...
                    <div class="testimonial-card flex flex-col w-[359px] shrink-0 rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden bg-obito-grey">
                                <img src="{{ asset('obito/assets/images/photos/3rdPerson.png') }}" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                                <p class="font-semibold">Angga Risky</p>
                                <p class="text-sm text-obito-text-secondary">Full Stack Developer</p>
