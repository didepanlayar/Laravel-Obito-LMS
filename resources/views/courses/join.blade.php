...
@section('title', 'Join - Obito Online Learning Platform')

@section('content')
    <div class="relative flex justify-center">
        <div id="backgroundImage" class="absolute top-0 left-0 right-0">
            <img src="{{ asset('obito/assets/images/backgrounds/success-join.png') }}" alt="image" class="h-[777px] object-cover object-bottom w-full" />
        </div>
        <main class="relative mt-[178px] flex flex-col gap-[30px] p-[30px] w-[560px] rounded-[20px] border bg-white border-obito-grey">
            <img src="{{ asset('obito/assets/images/icons/raising-hands.png') }}" alt="icon" class="size-[60px] shrink-0 mx-auto" />
            ...
            <div id="card" class="flex items-center pt-[10px] pb-[10px] pl-[10px] pr-4 border border-obito-grey rounded-[20px] gap-4">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('obito/assets/images/icons/crown-green.svg') }}" alt="icon" class="size-5 shrink-0" />
                        <p class="text-sm leading-[21px] text-obito-text-secondary">{{ $course->category->name }}</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('obito/assets/images/icons/menu-board-green.svg') }}" alt="icon" class="size-5 shrink-0" />
            ...
            <div class="buttons grid grid-cols-2 gap-[12px]">
                ...
                <a href="{{ route('dashboard.course.learning', ['course' => $course->slug, 'courseSection' => $firstSectionId, 'sectionContent' => $firstContentId,]) }}" class="text-white rounded-full py-[10px] flex justify-center items-center bg-obito-green hover:drop-shadow-effect transition-all duration-300">
