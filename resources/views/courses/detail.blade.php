...
@section('title', 'Detail - Obito Online Learning Platform')
        ...
        <ul class="flex w-full max-w-[1280px] px-[75px] mx-auto gap-3">
            <li class="group">
                <a href="#" class="flex items-center gap-2 rounded-full border border-obito-grey py-2 px-[14px] hover:border-obito-green bg-white transition-all duration-300 group-[.active]:bg-obito-light-green group-[.active]:border-obito-light-green">
                    <img src="{{ asset('obito/assets/images/icons/home-trend-up.svg') }}" class="flex shrink-0 w-5" alt="icon">
                    <span>Overview</span>
                </a>
            </li>
            <li class="group">
                <a href="catalog-v2.html" class="flex items-center gap-2 rounded-full border border-obito-grey py-2 px-[14px] hover:border-obito-green bg-white transition-all duration-300 group-[.active]:bg-obito-light-green group-[.active]:border-obito-light-green">
                    <img src="{{ asset('obito/assets/images/icons/note-favorite.svg') }}" class="flex shrink-0 w-5" alt="icon">
                    <span>Courses</span>
                </a>
            </li>
            <li class="group">
                <a href="#" class="flex items-center gap-2 rounded-full border border-obito-grey py-2 px-[14px] hover:border-obito-green bg-white transition-all duration-300 group-[.active]:bg-obito-light-green group-[.active]:border-obito-light-green">
                    <img src="{{ asset('obito/assets/images/icons/message-programming.svg') }}" class="flex shrink-0 w-5" alt="icon">
                    <span>Quizzess</span>
                </a>
            </li>
            <li class="group">
                <a href="#" class="flex items-center gap-2 rounded-full border border-obito-grey py-2 px-[14px] hover:border-obito-green bg-white transition-all duration-300 group-[.active]:bg-obito-light-green group-[.active]:border-obito-light-green">
                    <img src="{{ asset('obito/assets/images/icons/cup.svg') }}" class="flex shrink-0 w-5" alt="icon">
                    <span>Certificates</span>
                </a>
            </li>
            <li class="group">
                <a href="#" class="flex items-center gap-2 rounded-full border border-obito-grey py-2 px-[14px] hover:border-obito-green bg-white transition-all duration-300 group-[.active]:bg-obito-light-green group-[.active]:border-obito-light-green">
                    <img src="{{ asset('obito/assets/images/icons/ruler&pen.svg') }}" class="flex shrink-0 w-5" alt="icon">
        ...
        <header class="flex items-center w-full max-w-[1000px] rounded-[20px] border border-obito-grey p-5 gap-[30px] bg-white mx-auto">
            <div id="thumbnail-container" class="flex relative w-[500px] h-[350px] shrink-0 rounded-[14px] overflow-hidden bg-obito-grey">
                ...
                <p class="absolute bottom-[10px] left-[10px] z-10 w-fit h-fit flex flex-col items-center rounded-[14px] py-[6px] px-[10px] bg-white gap-0.5 z-10">
                    <img src="{{ asset('obito/assets/images/icons/like.svg') }}" class="w-5 h-5" alt="icon">
                ...
                <button type="button" class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 z-10">
                    <img src="{{ asset('obito/assets/images/icons/video-circle-green-fill.svg') }}" class="flex w-[60px] h-[60px] shrink-0" alt="icon">
                </button>
            </div>
                ...
                <div class="flex flex-col gap-[10px]">
                    @if ($course->is_popular)
                        <p id="badge" class="flex items-center bg-custom-gradient gap-[6px] rounded-[14px] py-[6px] px-2 w-fit">
                            <img src="{{ asset('obito/assets/images/icons/cup-white.svg') }}" class="w-5 flex shrink-0" alt="icon">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex gap-4 items-center">
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('obito/assets/images/icons/crown-green.svg') }}" class="w-6 flex shrink-0" alt="icon">
                            <span class="font-semibold text-sm leading-[21px]">{{ $course->category->name }}</span>
                        </p>
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('obito/assets/images/icons/menu-board-green.svg') }}" class="w-6 flex shrink-0" alt="icon">
                            <span class="font-semibold text-sm leading-[21px]">{{ $course->content_count }} Lessons</span>
                        </p>
                    </div>
                    <div class="flex gap-4 items-center">
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('obito/assets/images/icons/briefcase-green.svg') }}" class="w-6 flex shrink-0" alt="icon">
                ...
                <div id="tabs-content-container">
                        ...
                        <div id="what-you-learn" class="flex flex-col gap-4">
                            ...
                            <div class="grid grid-cols-2 gap-x-[30px] gap-y-4 w-full max-w-[700px]">
                                @foreach ($course->benefits as $benefit)
                                    <div class="flex items-center gap-3">
                                        <img src="{{ asset('obito/assets/images/icons/tick-circle-green-fill.svg') }}" class="w-6 flex shrink-0" alt="icon">
                                        <p>{{ $benefit->name }}</p>
                                    </div>
                                @endforeach
                            </div>
                                    ...
                                    <div class="instructors-card flex flex-col rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center">
                                                <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0" alt="icon">
                                                <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0" alt="icon">
                                                <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0" alt="icon">
                                                <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0" alt="icon">
                                                <img src="{{ asset('obito/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0" alt="icon">
                        ...
                        @foreach ($course->courseSections as $section)
                            <div class="accordion flex flex-col gap-4 rounded-[20px] border border-obito-grey p-5 bg-white">
                                <button type="button" id="accordion-btn" data-expand="{{ $section->id }}" class="flex items-center justify-between">
                                    ...
                                    <img src="{{ asset('obito/assets/images/icons/arrow-circle-down.svg') }}" alt="icon" class="size-6 shrink-0 transition-all duration-300 -rotate-180" />
                                </button>
                                    ...
                                    <div class="flex flex-col gap-4">
                                        @foreach ($section->sectionContents as $content)
                                            <div class="flex items-center rounded-[50px] gap-[10px] border border-obito-grey py-3 px-4 bg-white">
                                                <img src="{{ asset('obito/assets/images/icons/menu-board.svg') }}" class="size-6 flex shrink-0" alt="icon">
                    ...
                    <div id="testimonials-content" class="tab-content grid grid-cols-2 w-full max-w-[860px] gap-5 hidden">
                        <div class="testimonial-card flex flex-col rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('obito/assets/images/photos/sami.png') }}" class="w-full h-full object-cover" alt="photo">
                                </div>
                                <div>
                        ...
                        <div class="testimonial-card flex flex-col rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('obito/assets/images/photos/4thPerson.png') }}" class="w-full h-full object-cover" alt="photo">
                                </div>
                                <div>
                                    <p class="font-semibold">Angga Risky</p>
                                    <p class="text-sm text-obito-text-secondary">Full Stack Developer</p>
                        ...
                        <div class="testimonial-card flex flex-col rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('obito/assets/images/photos/anggaphoto.png') }}" class="w-full h-full object-cover" alt="photo">
                                </div>
                                <div>
                                    <p class="font-semibold">Angga Risky</p>
                                    <p class="text-sm text-obito-text-secondary">Full Stack Developer</p>
                        ...
                        <div class="testimonial-card flex flex-col rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('obito/assets/images/photos/5thPerson.png') }}" class="w-full h-full object-cover" alt="photo">
                                </div>
                                <div>
                                    <p class="font-semibold">Angga Risky</p>
                                    <p class="text-sm text-obito-text-secondary">Full Stack Developer</p>
                        ...
                        <div class="testimonial-card flex flex-col rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex w-[50px] h-[50px] shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('obito/assets/images/photos/3rdPerson.png') }}" class="w-full h-full object-cover" alt="photo">
                                </div>
                                <div>
                                    <p class="font-semibold">Angga Risky</p>
                                    <p class="text-sm text-obito-text-secondary">Full Stack Developer</p>
...
@push('after-scripts')
    <script src="{{ asset('obito/js/dropdown-navbar.js') }}"></script>
    <script src="{{ asset('obito/js/tabs.js') }}"></script>
    <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    <script src="{{ asset('obito/js/accordion.js') }}"></script>
@endpush
